...
- (id)initWithTableView:(UITableView *)tableView cancelButton:(BOOL)showButton {
    ...
    if (self) {
        ...
        self.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"progress_view_background.png"]];
        ...
        self.progressLabel.font = [UIFont fontWithName:@"Montserrat" size:13.0];
        ...
        if (showButton) {
            [self.progressView setFrame:CGRectMake(56.0, 32.0, mainScreen.bounds.size.width - 80, 11.0)];
        } else {
            [self.progressView setFrame:CGRectMake(56.0, 32.0, mainScreen.bounds.size.width - 80, 11.0)];
        }
