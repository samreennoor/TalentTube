...
- (void)setUpTitleLabel {
    ...
    if (!titleLabel) {
        ...
        if(IS_IPAD)
        titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, rect.origin.y + 64, rect.size.width - 60, 24)];
        else
        titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, rect.origin.y + 44, rect.size.width - 60, 24)];
        [titleLabel setText:titleString];
        [titleLabel setTextAlignment:NSTextAlignmentCenter];
        [titleLabel setTextColor:[UIColor whiteColor]];
        [titleLabel setFont:[UIFont fontWithName:@"Montserrat" size:16.0]];
...
- (void)setAlertType:(AlertType)alertType {
    ...
    if (alertType == AlertTypeError) {
        ...
        [alertView setBackgroundColor:[UIColor colorWithRed:0.160  green:0.222 blue:0.478 alpha:1] /*#3293d3*/];
    }
...
- (CGRect)alertRect {
    ...
    if(IS_IPAD)
         return CGRectMake(-20, -10, mainScreen.bounds.size.width + 40, 104);
    else
