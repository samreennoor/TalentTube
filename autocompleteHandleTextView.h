...
- (nonnull id)initWithFrame:(CGRect)frame handleCharacterAllowed:(nonnull NSString *)handleCharacterAllowed hashtagCharacterAllowed:(nonnull NSString *)hashtagCharacterAllowed colorHandle:(nonnull UIColor *)colorHandle colorHashtag:(nonnull UIColor *)colorHashtag textToDisplay:(nonnull NSString *)textToDisplay delegate:(nonnull id<AutocompleteHandleTextViewDelegate>)instanceDelegates;
