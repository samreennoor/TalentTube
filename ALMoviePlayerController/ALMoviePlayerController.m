...
//                
//                self.movieBackgroundView.frame = CGRectMake(0, 100, self.backgroundView.frame.size.width, self.backgroundView.frame.size.height);
//                self.controls.frame = CGRectMake(0, 400, self.controls.frame.size.width, self.controls.frame.size.height);
