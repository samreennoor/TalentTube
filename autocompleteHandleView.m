...
- (void)showHandle:(NSArray *)handleArray
{
    ...
    for (int i = 0; i < handleArray.count; i++) {
        ...
        [btn setTitleColor:[UIColor colorWithRed:0.211 green:0.305 blue:0.552 alpha:1] forState:UIControlStateNormal];
        btn.titleLabel.font = [UIFont fontWithName:@"Montserrat" size:13.0f];
